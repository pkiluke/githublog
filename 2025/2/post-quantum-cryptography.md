...
there are standardization bodies such as **ISO/IEC**, **IETF**, **ETSI** developing and updating standards to mandate the use of state-of-the-art cryptography and there are governments around the world including the **EU Commission**, **[Germany (BSI)](https://www.bsi.bund.de/EN/Themen/Unternehmen-und-Organisationen/Informationen-und-Empfehlungen/Quantentechnologien-und-Post-Quanten-Kryptografie/quantentechnologien-und-post-quanten-kryptografie_node.html)**, **France (ANSSI)**, **Netherlands**, **the UK (UK-NCSC, GCHQ)**, **Czech Republic (NÚKIB)** and **USA** all pushing for the adoption of PQC.
